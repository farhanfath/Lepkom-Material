 ...
 */
package pertemuan6.musicplayer;
...
import sun.audio.AudioPlayer;  //only work on java 9 under
import sun.audio.AudioStream;  //only work on java 9 under
...
public class MusicPlayer extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txt_file, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btn_playActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_playActionPerformed
        ...
        InputStream in; 
        try { 
            in = new FileInputStream(txt_file.getText()); 
            AudioStream audio = new AudioStream(in); //only work on java 9 under
            AudioPlayer.player.start(audio); //only work on java 9 under
        }catch(Exception e) { 
